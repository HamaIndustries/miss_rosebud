    ...
    try:
        if message.author.id == wishid:
            await client.send_message(
                message.channel,
                "Added {} {} to your account, my Queen. Feel free to ask for more. xwu".format(
        ...
        await client.send_message(
            message.channel,
            "Added {} {} to your account for today!".format(
                await target.daily(), Profile.currency_name
            ),
        )
        ...
        await client.send_message(
            message.channel,
            "Please wait {:.2f} hours before begging for more {}.".format(
...
async def pay(client, message):
    ...
    if payer.id == wishid:
        ...
        await client.send_message(
            message.channel, "Trying to defraud me? Nice try idiot."
        )
        return
    elif message.mentions[0].bot:
        await client.send_message(
            message.channel, "You can't even buy a bot's love, small dick energy cuck."
        )
        return

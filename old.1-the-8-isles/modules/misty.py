...
async def vore(client, message):
    if len(message.mentions) < 1:
        await client.send_message(
            message.channel, "please specify a user to vore! ***xvo***"
        )
        return
    ...
    if target.id == client.user.id:
        if message.author.id == "352229851576401930":  # seth
            ...
            await client.send_message(
                message.channel,
                "**>p<** M-Master~~!!!! I,, I love being inside of you master,, but I'd rather",
            )
            await asyncio.sleep(2)
            await client.send_message(
                message.channel,
            ...
            await client.send_message(
                message.channel, ">p< Your esophagus is so warm,,"
            )
    else:
        await client.send_message(
            message.channel,
            "{} vored {}! I hope they lubed up first. X_O".format(

...
def command(name, help="", category="misc"):  # misc, general, money, marriage, image
    def real_command_hehe(func):
        commands_dict[name] = {"command": func, "help": help, "category": category}
        return func
...
def wishicommand(name, help="", category="misc"):
    def real_command_hehe(func):
        wishicommands_dict[name] = {"command": func, "help": help, "category": category}
        return func
...
def admincommand(name, help="", category="misc"):  # all including admin
    def real_command_hehe(func):
        admincommands_dict[name] = {"command": func, "help": help, "category": category}
        return func
...
def secretcommand(name):
    def real_command_hehe(func):
        secretcommands_dict[name] = {"command": func, "help": "", "category": "secret"}
        return func

...
def fetch(entries):
    ...
    try:
        print('==={} to {}( {} ): {}'.format(bot_info.user.name, discord.utils.get(bot_info.client.get_all_members(), id=dic['id']).name.translate(trans),dic['id'], dic['message']))
    except AttributeError:
        print('==={} to {}( {} ): {}'.format(bot_info.user.name, discord.utils.get(bot_info.client.get_all_channels(), id=dic['id']).name.translate(trans),dic['id'], dic['message']))
    global root
